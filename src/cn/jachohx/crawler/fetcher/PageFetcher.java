...
import cn.jachohx.crawler.Configurable;
import cn.jachohx.crawler.config.CrawlConfig;
import cn.jachohx.crawler.url.URLCanonicalizer;
	...
	public PageFetchResult fetchHeader(WebURL webUrl) {
		...
		try {
			...
			if(header != null){
				...
				String charset = UrlUtils.getCharsetFromContentTypeString(contentType);
				fetchResult.setCharset(charset);
			}
